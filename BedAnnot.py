"""
Zhongshan Cheng, updated the script to use cnn as default!
Jun-18-2025
"""
...
def main(hisat2Bed,minimap2Bed,gmapBed,baseOutDir,sample,suffix1,db,fa,cnn=1,TPM=0,report=0):
...
if __name__ == '__main__':
    ...
    main(args.hisat2, args.minimap2, args.gmap, args.output,args.sample, args.suffix, gtf2db.dict_make(args.gtf),args.fa, cnn=1, TPM=args.tpm, report=args.report)
